...
public class Main {
    ...
    public static void addToList(List<String> list, String name) {
        for(String nume : list) {
            if(Objects.equals(nume, name)) throw new DuplicateEntryException("'" + name + "' exista deja in lista!");
        }
        list.add(name);
    }
    ...
    public static void main(String[] args) {
        ...
        List<String> lista = new ArrayList<>(Arrays.asList("Ana", "Mihai", "Ion"));
        try {
            addToList(lista, "Ana");
        ...
        catch (InvalidAgeException e) { // java: exception com.pao.laboratory03.exceptions.InvalidAgeException has already been caught
            System.out.println("Eroare: " + e.getMessage());
        }
        */
